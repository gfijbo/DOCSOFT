...
class CarriereController extends ListPage
{
    ...
    {
        return $this->listChamp("Carrière / Propositions avancement","gestion/carriere/proava/pdf",'4', '35');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Arretés d'avancements","gestion/carriere/arrava/pdf",'4', '36');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Demandes","gestion/carriere/demandes/pdf",'4', '37');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Demande de temps partiel","gestion/carriere/demtempar/pdf",'4', '38');
    }
    ...
    {
        return $this->listChamp("Carrière / Visites médicales","gestion/carriere/vismed/pdf",'4', '39');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Vaccination","gestion/carriere/vaccination/pdf",'4', '40');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Historique","gestion/carriere/historique/pdf",'4', '41');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Historique évènements","gestion/carriere/hiseve/pdf",'4', '42');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Infos médaille","gestion/carriere/infmed/pdf",'4', '44');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Sanction","gestion/carriere/sanction/pdf",'4', '45');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Double carrière","gestion/carriere/doucar/pdf",'4', '46');
    }
    /**
     *
    ...
    {
        return $this->listChamp("Carrière / Chronologie des évènements","gestion/carriere/chreve/pdf",'4', '47');
    }
    /**
     *
